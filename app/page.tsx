  ...
  const newsList = [
    {
      ...
      content:
        "项目名借鉴了<b>maa.plus</b>；透明视频实现方案借鉴了<b>endfield.hypergryph.com</b>；页面结构借鉴了<b>vrp.live</b>。感谢上述网站的大力支持。<br/>Producer在编写成员简介时埋藏了很多小巧思，请务必阅读，万分感谢。<br/>遗憾的是，本次并未同步开放社团新成员招募，有兴趣加入的朋友请关注我们的后续动态。", // 新闻内容
    },
  ];
